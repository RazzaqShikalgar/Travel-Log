...
const getUserInputs = () => {
  ...
  nameElem.addEventListener("keyup", (e) =>
    validateFormData(e.target, validType.TEXT, "Place Name")
  );
  citynameElem.addEventListener("keyup", (e) =>
    validateFormData(e.target, validType.ANY, "City Name")
  );
  countrynameElem.addEventListener("keyup", (e) =>
    validateFormData(e.target, validType.TEXT, "Country Name")
  );
  transportElem.addEventListener("keyup", (e) =>
    validateFormData(e.target, validType.ANY, "Transport")
  );
  todoElem.addEventListener("keyup", (e) =>
    validateFormData(e.target, validType.TEXT, "todo")
  );
  BudgetElem.addEventListener("keyup", (e) =>
    validateFormData(e.target, validType.ANY, "Budget")
  );
  StayElem.addEventListener("keyup", (e) =>
    validateFormData(e.target, validType.TEXT, "Stay")
  );
  BlogTitleElem.addEventListener("keyup", (e) =>
    validateFormData(e.target, validType.ANY, "Title")
  );
  BlogDescriptionElem.addEventListener("keyup", (e) =>
  ...
  contactElem.addEventListener("keyup", (e) =>
    validateFormData(e.target, validType.ANY, "Contact")
  );
...
const displaytrip = (userData) => {
  nameDsp.innerHTML =
    userData.name + " " + userData.cityname + " " + userData.countryname;
